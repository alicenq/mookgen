/* global NV:false, MGEval:true, math:false */
NV.import('js/mgstruct.js');
 ...
 * 
 */
MGEval.select = function (options) {
 ...
 * @param {*} context 
 */
MGEval.resolve = function (input, context) {
...
/**
     ...
     * */
MGEval.__pass = function (input, rx, evaluate) {
